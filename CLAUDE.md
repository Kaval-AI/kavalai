...
| `examples/` | Runnable usage examples; `business_info_agent.py` also seeds the agent DB with demo runs (agent, sessions, runs, tasks, chat, model stats) for backoffice demos and screenshots |
