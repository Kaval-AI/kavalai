...
| `docs/` | Sphinx documentation (`sphinx_immaterial`): `tutorials/` (incl. notebook symlinks into `notebooks/`), `guides/` (concepts), `reference/` (YAML, bundled tools, env vars), `cookbook/`, `deploy/`, `ui/`, autogenerated `api/`, and `todo.rst` for open maintainer questions |
